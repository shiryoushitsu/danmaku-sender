  ...
  <el-col :span="12" >
    <el-card style="width:600px;float:right;min-height:616px" body-style="padding-top:5px">
      ...
      <!-- <el-row  style="margin-top:18px">
        <el-col :span="5">
        <el-button type="primary" @click="submitForm2()">调整发送</el-button>
        </el-col>
        <el-col :span="5">
        <el-button type="primary" >剩余发送</el-button>
        </el-col>
      </el-row> -->
  ...
  <el-tabs v-model="activeName" >
    <el-tab-pane label="基本配置" name="first">
        ...
        <el-row>
          ...
          <el-col :span="12">
                  <el-form-item size="middle" label="分P号" prop="part" label-width="100px" >
        ...
        <el-row>
          ...
          <el-form-item size="middle" label="时间补偿值" prop="sendFirstDmOffset" label-width="100px">
                ...
                <el-col :span="12">
                  <el-form-item size="middle" label="弹幕池" prop="pool" label-width="100px">
     ...
     <el-row>
        ...
        <el-row>
          <el-col :span="12">
                  <el-form-item size="middle" label="发送模式" prop="sendMode" label-width="100px">
          ...
          <el-col :span="12">
                               ...
                               <el-form-item size="middle" label="弹幕模式" prop="mode" label-width="100px">
                    <el-select v-model="form.mode" placeholder="弹幕模式">
                      <el-option label="滚动弹幕" value="1"></el-option>
                      <el-option label="底部弹幕" value="4"></el-option>
                      <el-option label="顶部弹幕" value="5"></el-option>
                    </el-select>
                  </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="12">
                  ...
                  <el-form-item size="middle" label="上传lrc文件" label-width="100px">
    ...
    <el-tab-pane label="更多配置" name="second">
            ...
            <el-row>
              <el-col :span="12">
                      ...
                      <el-form-item size="middle" label="弹幕前缀" prop="sendPrefix" label-width="100px">
                        <el-input v-model="form.sendPrefix"  placeholder="弹幕前缀附加内容" />
                      </el-form-item>

              </el-col>
              <el-col :span="12">

                      <el-form-item size="middle" label="弹幕后缀" prop="sendSuffix" label-width="100px">
                        <el-input v-model="form.sendSuffix"  placeholder="弹幕后缀附加内容" />
                      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submitVideoPreviewForm(){
      ...
      this.axios.post('/danmaku/previewSendDanmakuM1', param, config).then(res => {
        debugger
        if(res.data.code == 200){
            this.textarea = res.data.msg
        }
